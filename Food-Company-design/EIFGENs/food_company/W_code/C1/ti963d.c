...
static const EIF_TYPE_INDEX egt_13_963 [] = {0xFF01,959,0xFFFF};
...
static const struct desc_info desc_963[] = {
	...
	{EIF_GENERIC(egt_13_963), 13265, 0xFFFFFFFF},
	{EIF_GENERIC(egt_14_963), 13266, 0xFFFFFFFF},
	...
	{EIF_GENERIC(egt_15_963), 13269, 0xFFFFFFFF},
};
void Init963(void)
{
	IDSC(desc_963, 0, 962);
	IDSC(desc_963 + 1, 1, 962);
	IDSC(desc_963 + 32, 378, 962);
	IDSC(desc_963 + 36, 382, 962);
}
